...
import { teachers, kursants3471 } from "./parse.js";
...
for (let i = 0; i < request.length; i++) {
	...
	let prompt = `Напиши сообщение на тему ${theme}. Текст должен состоять из содержания, введения, основной части, заключения и списка литературы. Уложись в 2 страницы листа А4`;
	...
	console.log(`Ваш итоговый документ (${i+1}): "${docParts[1]}.docx" лежит по данному пути: \n /DocGenPC/outputdocs/${docParts[1]}.docx`);
