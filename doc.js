...
export async function doc(type='Доклад', theme, kursant, group, teacher, pages=2) {
    ...
    try {
        ...
        let prompt = `Напиши сообщение на тему ${theme}. Текст должен состоять из содержания, введения, основной части, заключения и списка. Уложись в ${pages} страниц минимум.`;
        console.log(prompt);
